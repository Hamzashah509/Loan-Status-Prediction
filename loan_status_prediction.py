...
input_data = (0, 0, 0, 1, 0, 2900, 0, 71, 360, 1, 0)
input_array = np.asarray(input_data)

# Reshape the array to have one instance
reshaped_input = input_array.reshape(1, -1)

# Assuming you have a trained model named 'classifier'
prediction = classifier.predict(reshaped_input)
